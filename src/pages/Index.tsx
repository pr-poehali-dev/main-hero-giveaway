      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 w-full max-w-3xl mx-auto px-6 pt-20 pb-10 text-center animate-fade-in">
          ...
          <p className="text-white/50 text-base font-light max-w-xs mx-auto mt-4">
            Спасибо всем участникам. Розыгрыш прошёл честно — при всех гостях мероприятия. Если вы не получили приз в день розыгрыша, свяжитесь с AlAero Group. Призы вручаются лично при предъявлении выигрышного билета (конверта).
          </p>
        </div>
      </section>
